...
const AdminMovies = () => {
  ...
  // load movies stored in CineSnap DB
  const fetchMovies = async () => {
    try {
      const res = await api.get("/movies", { params: { all: true } });
      setMovies(res.data);
    } catch (err) {
      console.error(err);
  ...
  const handleSearch = async (e) => {
    ...
    console.log("TMDB results:", results); // <--- debug
                ...
                <div key={m.id} className="movie-card">
                  ...
                  <div className="movie-card-body">
                    ...
                    <p className="movie-overview">
                      {m.overview || "No description from TMDB."}
                    </p>
                    <button
                      className="btn"
                      type="button"
